...
export default function Header({ onDashboard, onAdmin, kosongCount, totalBeds }) {
  return (
    <div className="bg-primary px-4 pt-6 pb-8 rounded-b-3xl shadow-lg">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={onAdmin}
            className="bg-white/20 hover:bg-white/30 text-white px-3 py-1.5 rounded-xl text-sm font-medium transition-all flex items-center gap-1"
