...
export default function SuccessPage({ room, onHome }) {
  return (
    <div className="min-h-screen bg-accent flex items-center justify-center px-6">
      <div className="bg-white rounded-3xl card-shadow p-8 text-center max-w-sm w-full animate-[fadi_0.4s_ease-out]">
        ...
        <p className="text-muted text-sm mb-6">
          Maklumat anda telah diterima. Tuan Rumah akan hubungi anda segera melalui WhatsApp.
        </p>
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-muted">
            No. WhatsApp: 012-345 6789 (Tuan Rumah)
          </p>
        </div>
      </div>
    </div>
