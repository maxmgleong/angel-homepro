import { ArrowLeft, MapPin, Wifi, Snowflake, Refrigerator, Car, WashingMachine } from 'lucide-react'
    ...
    <div className="min-h-screen bg-accent">
      ...
      <div className="px-4 -mt-6 relative z-10">
        ...
        <h3 className="text-sm font-bold text-muted uppercase tracking-wide mb-3">
          {property.rooms.length} Bilik Tersedia
        </h3>
                  ...
                  <div className="flex-1 p-3">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted mt-0.5">{room.description.substring(0, 50)}...</p>
                      </div>
