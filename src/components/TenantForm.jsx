...
export default function TenantForm({ room, onBack, onSubmit }) {
  ...
  return (
    <div className="min-h-screen bg-accent">
      ...
      <div className="px-4 -mt-4">
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl card-shadow p-5 space-y-4">
          ...
          <div>
            ...
            <div
              ...
              className="border-2 border-dashed border-accent rounded-2xl p-6 text-center cursor-pointer hover:border-primary transition-colors"
            >
              {icPreview ? (
        ...
        <p className="text-center text-muted text-xs mt-4 mb-6">
          ⚠️ Maklumat anda disimpan secara tempatan untuk demo sahaja.
        </p>
      </div>
    </div>
  )
